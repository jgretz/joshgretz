const TrailSvg = () => (
  ...
  >
    {/* Far hills */}
    <path
      d="M0 200 Q80 100 200 140 T450 110 T700 150 T1000 120 L1000 200 Z"
      fill="#c4a574"
    />
    {/* Near hills */}
    <path
      d="M0 200 Q150 140 350 170 T700 155 T1000 180 L1000 200 Z"
      fill="#8b7355"
    />
...
export const StravaCTASection = () => (
  <section>
    <div className="relative overflow-hidden rounded-2xl bg-warm-700 p-12">
      <TrailSvg />
      <div className="relative z-10 flex flex-wrap items-center justify-between gap-8">
        <div>
          <p className="font-hand text-lg text-warm-400">follow along</p>
          <h2 className="mt-1 font-serif text-3xl text-warm-50">Want to see what tomorrow brings?</h2>
