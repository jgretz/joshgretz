...
export default function Index() {
	return (
		<Page>
			<ContentBlock>
				I'm a husband, father, maker, developer, runner, cook, baker, nerd,
				geek, and fan of nearly every sport invented.
			</ContentBlock>
			...
			<ContentBlock>
				...
				work. I have strong opinions, yet try to hold them loosely, and strive
				to express them humbly. I desire to continually improve.
			</ContentBlock>
			...
			<ContentBlock>
				This site is a reflection of all of these thoughts and more ...
			</ContentBlock>
		</Page>
	);
}
