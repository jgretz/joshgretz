	...
	return (
		<div className="flex flex-col items-center justify-center">
			...
			<div className="flex flex-row justify-center py-3">
				<a
					href="https://www.linkedin.com/in/joshgretz/"
					target="_blank"
					rel="noreferrer"
				>
				...
				<a
					href="https://www.instagram.com/joshgretz/"
					target="_blank"
					rel="noreferrer"
				>
				...
				<a
					href="https://bsky.app/profile/joshgretz.bsky.social"
					target="_blank"
					rel="noreferrer"
				>
					<img
						src={bluesky}
						alt="bluesky icon"
						className="h-[15px] w-[15px] mx-[8px] bg-black"
					/>
				</a>
				<a
					href="https://www.strava.com/athletes/67556995"
					target="_blank"
					rel="noreferrer"
				>
					<img
